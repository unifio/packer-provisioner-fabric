...
type FlatConfig struct {
	...
	FabricEnvVars        []string          `mapstructure:"fabric_env_vars" cty:"fabric_env_vars"`
	FabFile              *string           `mapstructure:"fab_file" cty:"fab_file"`
	FabTasks             *string           `mapstructure:"fab_tasks" cty:"fab_tasks"`
	FabTasksDelimiter    *string           `mapstructure:"fab_tasks_delimiter" cty:"fab_tasks_delimiter"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"fabric_env_vars":            &hcldec.AttrSpec{Name: "fabric_env_vars", Type: cty.List(cty.String), Required: false},
		"fab_file":                   &hcldec.AttrSpec{Name: "fab_file", Type: cty.String, Required: false},
		"fab_tasks":                  &hcldec.AttrSpec{Name: "fab_tasks", Type: cty.String, Required: false},
		"fab_tasks_delimiter":        &hcldec.AttrSpec{Name: "fab_tasks_delimiter", Type: cty.String, Required: false},
